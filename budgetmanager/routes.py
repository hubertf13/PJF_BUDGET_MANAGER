...
def reports():
    form = ReportForm()
    colors = ['rgba(255, 0, 0, 0.5)', 'rgba(0, 255, 0, 0.5)', 'rgba(0, 0, 255, 0.5)', 'rgba(255, 255, 0, 0.5)',
              'rgba(0, 255, 255, 0.5)', 'rgba(255, 0, 255, 0.5)', 'rgba(128, 0, 0, 0.5)', 'rgba(128, 128, 0, 0.5)',
              'rgba(0, 0, 128, 0.5)', 'rgba(128, 0, 128, 0.5)', 'rgba(0, 128, 128, 0.5)', 'rgba(255, 215, 0, 0.5)',
              'rgba(224, 255, 255, 0.5)', 'rgba(255, 0, 255, 0.5)', 'rgba(139, 69, 19, 0.5)',
              'rgba(112, 128, 144, 0.5)', 'rgba(75, 0, 130, 0.5)', 'rgba(106, 90, 205, 0.5)',
              'rgba(245, 222, 179, 0.5)', 'rgba(205, 133, 63, 0.5)', 'rgba(188, 143, 143, 0.5)',
              'rgba(255, 245, 238, 0.5)', 'rgba(220,20,60 0.5)', 'rgba(250,128,114, 0.5)', 'rgba(205, 92, 92, 0.5)',
              'rgba(240, 255, 240, 0.5)', 'rgba(105, 105, 105, 0.5)', 'rgba(255, 250, 250, 0.5)',
              'rgba(255, 218, 185, 0.5)', 'rgba(128, 0, 0, 0.5)', 'rgba(255, 127, 80, 0.5)', 'rgba(0, 255, 255, 0.5)',
              'rgba(46, 139, 87, 0.5)', 'rgba(240, 230, 140, 0.5)', 'rgba(255, 165, 0, 0.5)']
    ...
    if form.validate_on_submit():
        if form.time_range.data == "this_year":
            labels, values = get_bar_chart_values_of_actual_year(year)
